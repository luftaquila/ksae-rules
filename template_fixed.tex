...
\makeatletter
  \spaceskip=1.85\fontdimen2\font
...
\newcommand{\setupfancy}{
  ...
  \lfoot{\textbf{자동차공학은 한국의 힘!}}
  \cfoot{\textbf{\thepage}}
  \rfoot{\textbf{사단법인 한국자동차공학회}}
}
\makeatother
\setupfancy
...
\titleformat{\chapter}[hang]
  {\gtfamily\bfseries\fontsize{12}{16}\selectfont}
  {제\arabic{chapter}장}
  {0.5em}
  {}
...
\titleformat{\section}[block]
  {\gtfamily\bfseries\fontsize{10}{16}\selectfont}
  {}
  {0pt}
  {\lawformat}
